package com.react_native_web_example;
...
import com.react_native_web_example.newarchitecture.MainApplicationReactNativeHost;
  ...
  initializeFlipper(Context context,
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass =
            Class.forName("com.react_native_web_example.ReactNativeFlipper");
        aClass
